...
\maketitle
\section{Presentación del problema  {\ b \ underline {Knapsack}}} 

\subsubsection{Dado un espacio de tamaño W, y un conjunto de items e tamaños $(x1,x2..xn)$ y precios $(y1,y2..yn)$ se quiere hallar
