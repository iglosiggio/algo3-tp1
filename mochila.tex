...
Hemos considerado como resolver el problema de la mochila, con diferentes métodologias, así como hemos buscado identificar los tiempos de complejidad y memoria requerida, aplicado heúristicas que busquen podar y reducir el espacio de nuestro problema, así como hemos sometido a nuestros algoritmos a extensas pruebas.

Los resultados mas destacables son los siguientes:
\begin{enumerate}
	\item La poda por optimalidad debido al ordenamiento por valores que le permite armar rapidamente un buen candidato a la mejor mochila, puede mostrar un rendimiento muy superior que otros algoritmos como Meet in the Middle el cual posee una complejidad teórica mejor. 

	\item El algoritmo de memoria dinámica, tuvo un rendimiento extremadamente rapido en comparación con los otros algoritmos, manteniendo un consumo de memoria moderado, mejor a fuerza bruta y Meet in the Middle que requieren armar todo el espacio de soluciones, y muy inferior a los algoritmos de backtracking que realizan búsquedas exploratorias y poseen un consumo despreciable.
