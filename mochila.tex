...
\begin{center}
\includegraphics[width=0.9\linewidth]{{fotos/pdf.dinamica}.pdf}
\end{center}
...
\includegraphics[width=0.5\linewidth]{{fotos/exp.a.fuerza_bruta}.pdf}

\includegraphics[width=0.5\linewidth]{{fotos/exp.a.backtracking_fact}.pdf}

\includegraphics[width=0.5\linewidth]{{fotos/exp.a.backtracking_opt}.pdf}

\includegraphics[width=0.5\linewidth]{{fotos/exp.a.mitm}.pdf}

\includegraphics[width=0.5\linewidth]{{fotos/exp.a.dinamica}.pdf}
